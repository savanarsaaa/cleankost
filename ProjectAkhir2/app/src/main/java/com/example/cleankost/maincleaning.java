...
public class maincleaning extends AppCompatActivity { private RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(maincleaning.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(maincleaning.this, cleaningkost.class);
